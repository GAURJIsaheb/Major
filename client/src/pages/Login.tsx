...
function Login() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-8 bg-background overflow-hidden selection:bg-primary/20">
            ...
            <div className="z-10 w-full max-w-105 animate-in fade-in zoom-in-95 duration-500">
                <div className="mb-8 flex flex-col items-center justify-center text-center space-y-4">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-primary to-primary/80 shadow-xl shadow-primary/20 ring-1 ring-white/10">
                        <Users className="h-8 w-8 text-primary-foreground drop-shadow-md" />
                    </div>
                    <div className="space-y-1">
                        <h1 className="text-3xl font-bold tracking-tight bg-linear-to-r from-primary via-primary/90 to-primary/70 bg-clip-text text-transparent">
                            NexusHR
                        </h1>
